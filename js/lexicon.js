...
function mono(word, tones, fidelity, intervalType, glyph, gloss) {
...
const numbers = [
  ...
  mono("six", [131, 165, 196, 262, 392], "FAN-EXTENDED", "consonant", "◉◉◉◉◉",
    "Full 5-tone chord — base-6 completion, major feel."),
];
...
const verbs = [
  ...
  mono("see", [262, 349, 440], "FAN-EXTENDED", "open", "◉◉◉",
    "Open fourth — perception (ironic for eyeless Rocky)."),
...
export const QUESTION_PARTICLE = {
  word: "?",
...
// Quick lookup map
export const LEXICON_MAP = new Map(
  BASE_LEXICON.map((entry) => [entry.word.toLowerCase(), entry])
);

// Semantic clusters for UI display
